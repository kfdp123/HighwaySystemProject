...
submit_values.onclick=function(){
	...
	$.ajax({
		  type: "post", //请求方式
		  url: "http://localhost:2019/select_tiles_btob.ashx?LEFT_LAT=" + left_lat + "&LEFT_LNG=" + left_lng + "&RIGHT_LAT=" + right_lat + "&RIGHT_LNG=" + right_lng+"&EXP_PATH=" + export_path + "&IMP_PATH=" + import_path + "&DATA_TYPE=" + data_type+ "&TILE_LEVEL=" + tile_level, //地址，就是json文件的请求路径
